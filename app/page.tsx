...
export default function GarfadoApp() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden h-full">
      {/* Topbar — esconde na aba perfil pois ela tem seu próprio header */}
      {tab !== 'perfil' && (
        <header className="flex-shrink-0 flex items-center justify-between px-4 pt-4 pb-2">
          <div className="flex items-center gap-2">
            ...
            <span className="font-serif text-xl font-bold">{t(`tab.${tab}`)}</span>
          </div>
      ...
      <main className="flex-1 overflow-hidden flex flex-col">
        ...
        {tab === 'perfil' && <PerfilScreen onOpenModal={setModal} onViewProfile={setViewingUserId} />}
      </main>
